...
>> image: [[Map_Issylra.jpeg]] ### Link to the map image file. Do not add a ! in front of the image  
...
>>> > Issylra is one of the continents on the world of Exandria. It is a very large continent, almost the Exandrian equivalent of Asia. Much of it is a wild, untamed wilderness. 
>>>
>>> >[!div-m|no-title]
